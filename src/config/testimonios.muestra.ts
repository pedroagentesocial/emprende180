...
export const testimoniosMuestra: Testimonio[] = [
  {
    ...
    cita: {
      es: "Llevo doce años detrás de una silla oyendo a la gente contarme su vida, y nunca se me ocurrió que ahí había algo. El video 6 me dio las palabras exactas para preguntar. La primera vez me temblaba la voz y aun así funcionó.",
  ...
  },
  {
    ...
    cita: {
      es: "En el taller me llegan carros chocados todas las semanas y yo solo veía el golpe. Después del video 5 empecé a oír lo que me contaban mientras esperaban. En un mes reconocí cuatro situaciones que antes se me habrían pasado enteras.",
  ...
  },
  {
    ...
    cita: {
      es: "Yo tenía a la gente en notas del celular, en WhatsApp y en la cabeza, o sea en ningún lado. Con el video 7 metí 60 contactos al CRM en una tarde. Lo importante no fue meterlos: fue ver por primera vez con quién no hablaba hace ocho meses.",
  ...
  },
  {
    ...
    cita: {
      es: "Odio perseguir gente. El video 8 no va de publicar más, va de publicar algo que haga que te escriban. Cambié cómo contaba las cosas y en dos semanas me escribieron tres personas que yo no habría contactado nunca.",
  ...
  },
  {
    ...
    cita: {
      es: "Entré sin entender qué era esto exactamente y con la mosca detrás de la oreja, la verdad. Los tres primeros videos me dejaron claro quién hace qué y qué NO me tocaba a mí. Saber dónde acaba mi parte fue lo que me hizo animarme.",
  ...
  },
  {
    ...
    cita: {
      es: "Me había apuntado antes a cosas que sonaban bien y a las tres semanas ya no sabía qué hacer. Aquí el video 10 te obliga a escribir el plan: a quién llamas cada semana y cómo sabes si vas bien. Es lo único que me ha hecho seguir después del mes.",
